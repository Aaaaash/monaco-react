...
class DiffMatchPatch {
  constructor() {
    ...
    this.Match_MaxBits = this.getMaxBits();
  }
 ...
 */
DiffMatchPatch.prototype.diff_main = function(text1, text2, opt_checklines) {
 ...
 * @private
 */
DiffMatchPatch.prototype.diff_map = function(text1, text2) {
 ...
 * @private
 */
DiffMatchPatch.prototype.diff_path1 = function(v_map, text1, text2) {
  var path = [];
  var x = text1.length;
  var y = text2.length;
  /** @type {?number} */
 ...
 * @private
 */
DiffMatchPatch.prototype.diff_path2 = function(v_map, text1, text2) {
  var path = [];
  var pathLength = 0;
  var x = text1.length;
  var y = text2.length;
 ...
 * @private
 */
DiffMatchPatch.prototype.match_bitap = function(text, pattern, loc) {
 ...
 * @private
 */
DiffMatchPatch.prototype.match_alphabet = function(pattern) {
  var s = {};
 ...
 * @private
 */
DiffMatchPatch.prototype.patch_addContext = function(patch, text) {
  if (text.length == 0) {
    return;
  }
...
exports['diff_match_patch'] = DiffMatchPatch;
